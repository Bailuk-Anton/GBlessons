#############################################################################
# Makefile for building: gb
# Generated by qmake (3.1) (Qt 5.15.3)
# Project:  gb.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile gb.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = gb1.0.0
DISTDIR = /home/username/gb/gb_git/GBlessons/GBlessons/.tmp/gb1.0.0
LINK          = g++
LFLAGS        = 
...
Makefile: gb.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		gb.pro
	$(QMAKE) -o Makefile gb.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
classforfirstlesson.o: classforfirstlesson.cpp classforfirstlesson.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o classforfirstlesson.o classforfirstlesson.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/gb/bin || mkdir -p $(INSTALL_ROOT)/opt/gb/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/gb/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/gb/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/gb/bin/ 
